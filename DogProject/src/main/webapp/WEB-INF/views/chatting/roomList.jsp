...
<%@ page import="com.dto.ChatRoomDTO"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
		...
		<div class="col">
			<div class="card h-100">
				...
				<div class="card-footer bg-transparent d-flex justify-content-center">
					<a href="/test/chatRoom/<%=roomId%>" class="btn btn-outline-dark" onclick="return chkRoomUserCnt(<%=roomId%>);">입장하기</a>
				</div>
			</div>
		</div>
...
%>
		<div class="col">
			<div class="card h-100">
				...
				<div class="card-footer bg-transparent d-flex justify-content-center">
					<a href="/test/chatRoom/<%=roomId%>" class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#enterRoomModal" data-id="<%=roomId%>">입장하기</a>
				</div>
			</div>
		</div>
	...
	<div class="modal fade" id="roomModal" tabindex="-1" aria-labelledby="roomModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- form -->
				<form class="needs-validation" action="/test/roomAdd" method="post">
					<!-- modal-body -->
