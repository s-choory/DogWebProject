...
<span class="addObject">
    <span id="addPost"><img src="resources/img/icon/write.png"><a href="addPost">글쓰기+</a></span>
</span>
...
<span class="addObject">
    <span id="findMetting"><img src="resources/img/icon/search.png"><a href="MoIm2">Group</a></span>
</span><br>
