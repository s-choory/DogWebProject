...
List<ProductsDTO> Products_list = (List<ProductsDTO>) request.getAttribute("Products_list");
...
<a class="others" id="postOthers"  href="/test/?search=<%=search%>">더보기 +</a>
...
<a class="others" id="storeOthers" href="/test/search?SearchName=<%= search %>">더보기 +</a>
<div class="container" style="margin-left: 5%; margin-right: 5%;">
    <div class="posts"> 
   		<%
...
<a class="others" id="mapOthers" href="/test/map?RodeAddress=<%=search%>">더보기 +</a>
<!--  검색어에 대한 게시물 정보유무 if문 처리 -->
   <div class="container" style="margin-left: 5%; margin-right: 5%;">
    <%
    ...
    <% 
        ...
        <section class="posts_s">
            <% for(int i = 0; i<AccompanyingFacilities_list.size(); i++) { %>
                <a class="post_s" href="/test/map?RodeAddress=<%=AccompanyingFacilities_list.get(i).getFacilitiesName()%>">
                    <div class="post-content">
...
<a class="others" id="serviceCenterOthers" href="/test/ContactCenter_Notice">더보기 +</a>
<!--  검색어에 대한 게시물 정보유무 if문 처리 -->
    <div class="container" style="margin-left: 5%; margin-right: 5%;">
        <section class="posts">
         <%
