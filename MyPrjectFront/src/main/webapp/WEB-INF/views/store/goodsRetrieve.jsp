...
%>
	...
	<div class="container">
				...
				<div class="product-options" style="width: 17%">
					<div style="font-size: 16px;">
						...
						사이즈: <select class="select_change" size="1" name="Psize"
							...
							<option value="navy">S</option>
							<option value="black">M</option>
							<option value="ivory">L</option>
					...
					<div class="options-and-quantity">
						...
						<div style="padding-left: 10px">
							<!-- 패딩 조절 -->
							<input type="text" name="Amount" value="1" id="gAmount"
								style="text-align: right; height: 18px; width: 30px;"> <img
								src="resources/up.PNG" id="up">+ <img
								src="resources/down.png" id="down">-
						</div>
		...
		<div class="review" id="product-review">
			...
			<div class="select_img" contenteditable="true"><img src="" /></div>
...
%>
			<ul>
				<li>
					<div>
						<span><%= UserAlias %></span>
						<span style="font-size:11px; color:#FFAF0A;">
							<% if(Rating == 5) {%>
							<span >⭐⭐⭐⭐⭐</span>
							<% } else if(Rating == 4) {%>
						...
						<br>
						<span style="font-size:11px; color:gray; font-weight: bolder;"><%= CreationTime %></span>
					</div>
					<p><%= ReviewContent %></p>
					<%if(rThumbImg != null){ %>
						<img src="<%= rThumbImg %>" class="img" data-xxx="<%=rImg%>">
