...
<script>
	$(function(){
		$("#addressSearch").click(function() {
		    ...
		    var Category2 = ""; // 카테고리 변수 초기화

		    // 카테고리 값이 존재하는 경우
		    /* 카테고리 값이 존재하는 조건 */
		    if ($("#categoryFilter img.selected").length > 0) {
		    	Category2 = $("#categoryFilter img.selected").attr("id");
		    }

		    // URL 생성 및 리다이렉트
		    var url = "http://localhost:8096/test/map/search?RodeAddress=" + RodeAddress;
...
//		});
		...
		$("#categoryFilter img").click(function(data){
			...
			if (RodeAddress) {
				...
				location.href="http://localhost:8096/test/map/search?Category2="+Category2;
			}
		});
